        ...
        <div class="my_advert_wrapper">
            <table class="my_advert_quers_left">
                ...
                @foreach ($advertisements as $advertisement)
                    <tr>
                        <td>
                            <a href="{{url('/quer_overview/'.$advertisement->advertisement->id)}}">{{ $advertisement->amount_of_quers }}</a>
            ...
            <table class="my_advert_right">
                ...
                @foreach ($advertisements as $advertisement)
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="my_advert_right_max_height">{{ $advertisement->advertisement->event->name }} </div>
                        </td>
                        <td>
                            <div class="my_advert_right_max_height">{{ $advertisement->advertisement->private_description }}</div>
                        </td>
