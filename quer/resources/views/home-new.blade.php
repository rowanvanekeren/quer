...
<div id="login_home" class="login_form hidden">
...
<div id="register_home" class="register_form hidden">
        ...
        <nav class="home_navigation">
            <div>
                ...
                <ul class="home-nav-right-burger">
                    <li><img onclick="openNav()" class="burger" src="{{ asset('images/icons/burgermenu.png') }}"
                             width="40px"/></li>
                </ul>
                ...
                @foreach ($advertisements as $advert)
                    ...
                    <div style="background:url(./images/events/{{  $advert->event->image }})">
                        <div class="homepage-adverts-gradient">
                            ...
                            @else
                                <h2><a href="{{ url('/advert_overview/'. $advert->id) }}">{{$advert->event->name}}</a>
                                </h2>
                            @endif
